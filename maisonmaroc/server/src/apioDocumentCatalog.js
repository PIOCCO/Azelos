...
export const APIO_DOCUMENT_CATALOG = [
  // Institutionnel
  { id: "doc-presentation-apio", category: "institutionnel", sortOrder: 1, titleFr: "Présentation de l'APIO", descriptionFr: "Document de présentation institutionnelle de l'association (mission, gouvernance, services).", availability: "template", fileFormat: "PDF", templateKey: "doc-presentation-apio" },
  ...
  { id: "doc-charte-association", category: "institutionnel", sortOrder: 4, titleFr: "Charte de l'association", descriptionFr: "Principes et valeurs adoptés par l'APIO — modèle à valider institutionnellement.", availability: "template", fileFormat: "PDF", templateKey: "doc-charte-association" },
  { id: "doc-organigramme", category: "institutionnel", sortOrder: 5, titleFr: "Organigramme de l'association", descriptionFr: "Structure des organes et responsabilités (version officielle à publier).", availability: "template", fileFormat: "PDF", templateKey: "doc-organigramme" },
  ...
  // Membres
  { id: "doc-formulaire-adhesion", category: "membres", sortOrder: 1, titleFr: "Formulaire d'adhésion", descriptionFr: "Modèle de demande d'adhésion pour les promoteurs candidats.", availability: "template", fileFormat: "PDF", templateKey: "doc-formulaire-adhesion" },
  { id: "doc-dossier-adhesion", category: "membres", sortOrder: 2, titleFr: "Dossier d'adhésion", descriptionFr: "Checklist des pièces à assembler pour un dossier complet.", availability: "template", fileFormat: "PDF", templateKey: "doc-dossier-adhesion" },
  { id: "doc-bulletin-adhesion", category: "membres", sortOrder: 3, titleFr: "Bulletin d'adhésion", descriptionFr: "Bulletin type à signer lors de l'entrée en association.", availability: "template", fileFormat: "PDF", templateKey: "doc-bulletin-adhesion" },
  ...
  { id: "doc-conditions-adhesion", category: "membres", sortOrder: 5, titleFr: "Conditions d'adhésion", descriptionFr: "Critères et modalités d'adhésion fixés par l'APIO — modèle à compléter.", availability: "template", fileFormat: "PDF", templateKey: "doc-conditions-adhesion" },
  ...
  { id: "doc-formulaire-renouvellement", category: "membres", sortOrder: 7, titleFr: "Formulaire de renouvellement d'adhésion", descriptionFr: "Modèle pour le renouvellement périodique de l'adhésion.", availability: "template", fileFormat: "PDF", templateKey: "doc-formulaire-renouvellement" },
  // Professionnel
  { id: "doc-guide-promoteurs", category: "professionnel", sortOrder: 1, titleFr: "Guide des promoteurs immobiliers", descriptionFr: "Guide cadre pour les membres — contenu détaillé à valider par l'APIO.", availability: "template", fileFormat: "PDF", templateKey: "doc-guide-promoteurs" },
  { id: "doc-guide-bonnes-pratiques", category: "professionnel", sortOrder: 2, titleFr: "Guide des bonnes pratiques", descriptionFr: "Orientations professionnelles et éthiques — modèle évolutif.", availability: "template", fileFormat: "PDF", templateKey: "doc-guide-bonnes-pratiques" },
  { id: "doc-referentiel-professionnel", category: "professionnel", sortOrder: 3, titleFr: "Référentiel professionnel", descriptionFr: "Référentiel de compétences et exigences — à compléter institutionnellement.", availability: "template", fileFormat: "PDF", templateKey: "doc-referentiel-professionnel" },
  { id: "doc-fiche-projet", category: "professionnel", sortOrder: 4, titleFr: "Fiche de présentation d'un projet immobilier", descriptionFr: "Modèle de fiche projet pour communication interne et vitrine.", availability: "template", fileFormat: "PDF", templateKey: "doc-fiche-projet" },
  { id: "doc-formulaire-declaration-projet", category: "professionnel", sortOrder: 5, titleFr: "Formulaire de déclaration d'un projet", descriptionFr: "Signalement d'un nouveau projet par un membre.", availability: "template", fileFormat: "PDF", templateKey: "doc-formulaire-declaration-projet" },
  { id: "doc-modele-fiche-promoteur", category: "professionnel", sortOrder: 6, titleFr: "Modèle de fiche promoteur", descriptionFr: "Profil type pour l'annuaire des membres.", availability: "template", fileFormat: "PDF", templateKey: "doc-modele-fiche-promoteur" },
  { id: "doc-modele-fiche-projet", category: "professionnel", sortOrder: 7, titleFr: "Modèle de fiche projet", descriptionFr: "Fiche courte pour la présentation publique d'un projet.", availability: "template", fileFormat: "PDF", templateKey: "doc-modele-fiche-projet" },
  { id: "doc-charte-professionnelle", category: "professionnel", sortOrder: 8, titleFr: "Charte professionnelle", descriptionFr: "Engagements déontologiques des membres — modèle à valider.", availability: "template", fileFormat: "PDF", templateKey: "doc-charte-professionnelle" },
  // Administratif
  { id: "doc-fiche-membre", category: "administratif", sortOrder: 1, titleFr: "Fiche d'informations du membre", descriptionFr: "Informations administratives pour le suivi des adhésions.", availability: "template", fileFormat: "PDF", templateKey: "doc-fiche-membre" },
  { id: "doc-modele-correspondance", category: "administratif", sortOrder: 2, titleFr: "Modèle de correspondance officielle", descriptionFr: "Courrier type pour communications institutionnelles.", availability: "template", fileFormat: "PDF", templateKey: "doc-modele-correspondance" },
  { id: "doc-proces-verbaux", category: "administratif", sortOrder: 3, titleFr: "Procès-verbaux", descriptionFr: "PV des instances — publication sélective après validation.", availability: "coming_soon", fileFormat: "PDF" },
  { id: "doc-convocations-ag", category: "administratif", sortOrder: 4, titleFr: "Convocations aux assemblées", descriptionFr: "Modèles et convocations officielles des assemblées générales.", availability: "coming_soon", fileFormat: "PDF" },
  { id: "doc-ordres-du-jour", category: "administratif", sortOrder: 5, titleFr: "Ordres du jour", descriptionFr: "Ordres du jour des réunions statutaires.", availability: "coming_soon", fileFormat: "PDF" },
  { id: "doc-comptes-rendus", category: "administratif", sortOrder: 6, titleFr: "Comptes rendus de réunions", descriptionFr: "Comptes rendus approuvés des instances de gouvernance.", availability: "coming_soon", fileFormat: "PDF" },
  { id: "doc-communiques-officiels", category: "administratif", sortOrder: 7, titleFr: "Communiqués officiels", descriptionFr: "Communiqués publiés au nom de l'association.", availability: "coming_soon", fileFormat: "PDF" },
  { id: "doc-notes-information", category: "administratif", sortOrder: 8, titleFr: "Notes d'information", descriptionFr: "Notes destinées aux membres ou au public.", availability: "coming_soon", fileFormat: "PDF" },
  // Juridique
